...
const jsonFilePath = "./codeAnalysis/ca_responses/" + parent_json_file_name + "_ca.json";
const output_zip_files_path = "./codeAnalysis/output_zip_files";
const newFolderPath = output_zip_files_path + "Code Analysis MCQs";
const zipFilePath = "codeAnalysis/output_zip_files/" + parent_json_file_name + ".zip"; 
